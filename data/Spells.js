module.exports = [
    {
        ...
        attributes: ['KL', 'IN', 'FF'],
        modified_by: [],
        cost: { initial: 4, additional: { amount: 2, interval: 5, unit: 'Minuten' }, type: 'AsP' },
        effect: {
            description:
                'Das Talent Sinnesschärfe wird während der Wirkungsdauer um QS +3 des Zaubers erhöht.',
            duration: { amount: 5, modifier: 'aufrechterhaltend', unit: 'Minuten' },
            unit: null,
        },
        talent: null,
    ...
    },
    {
        ...
        attributes: ['KL', 'KL', 'IN'],
        modified_by: [],
        cost: { initial: 16, additional: {}, type: 'AsP' },
        effect: {
            description:
    ...
    },
    {
        ...
        attributes: ['KL', 'IN', 'FF'],
        modified_by: [],
        cost: { initial: 4, additional: null, type: 'AsP' },
        effect: {
            description:
    ...
    },
    {
        ...
        attributes: ['KL', 'IN', 'FF'],
        modified_by: [],
        cost: { initial: 8, additional: {}, type: 'AsP' },
        effect: {
            description:
    ...
    },
    {
        ...
        attributes: ['KL', 'IN', 'FF'],
        modified_by: [],
        cost: { initial: 4, additional: { amount: 1, interval: 1, unit: 'LeP' }, type: 'AsP' },
        effect: {
            description:
    ...
    },
    {
        ...
        cost: {
            initial: 8,
            additional: { amount: 4, interval: 30, unit: 'Sekunden' },
            type: 'AsP',
        },
        effect: {
            description: '',
            duration: { amount: 30, modifier: 'aufrechterhaltend', unit: 'Sekunden' },
            unit: null,
        },
        talent: null,
        spell: {
    ...
    },
    {
        ...
        attributes: ['MU', 'IN', 'CH'],
        modified_by: ['ZK'],
        cost: { initial: 4, additional: { amount: null, interval: null, unit: null }, type: 'asp' },
        effect: {
            description: '',
    ...
    },
    {
        ...
        effect: {
            description: '',
            duration: { amount: 'QS x2 Kampfrunden', modifier: 'QS x2 Kampfrunden', unit: null },
            unit: null,
        },
        talent: null,
        spell: {
    ...
    },
    {
        ...
        attributes: ['MU', 'KL', 'CH'],
        modified_by: [],
        cost: { initial: 8, additional: { amount: null, interval: null, unit: null }, type: 'asp' },
        effect: {
            description: '',
            duration: { amount: 'aufrechterhaltend', modifier: 'aufrechterhaltend', unit: null },
            unit: null,
        },
        talent: null,
        spell: {
    ...
    },
    {
        ...
        effect: {
            description: '',
            duration: { amount: 'QS x3 Kampfrunden', modifier: 'QS x3 Kampfrunden', unit: null },
            unit: null,
        },
        talent: null,
        spell: {
    ...
    },
    {
        ...
        effect: {
            description: '',
            duration: {
                amount: 'Bis zum nächsten Schuss, maximal QS x2 Kampfrunden',
                modifier: 'Bis zum nächsten Schuss, maximal QS x2 Kampfrunden',
                unit: null,
            },
            unit: null,
        },
    ...
    },
    {
        ...
        attributes: ['MU', 'KL', 'CH'],
        modified_by: [],
        cost: { initial: 2, additional: { amount: null, interval: null, unit: null }, type: 'asp' },
        effect: {
            description: '',
            duration: { amount: 'aufrechterhaltend', modifier: 'aufrechterhaltend', unit: null },
            unit: null,
    ...
    },
    {
        ...
        effect: {
            description: '',
            duration: { amount: '5 Minuten', modifier: '5 Minuten', unit: null },
            unit: null,
        },
        talent: null,
        spell: {
    ...
    },
    {
        ...
        effect: {
            description: '',
            duration: { amount: 'QS x 15 Minuten', modifier: 'QS x 15 Minuten', unit: null },
            unit: null,
        },
        talent: null,
        spell: {
    ...
    },
    {
        ...
        effect: {
            description: '',
            duration: { amount: 'QS x 3 Minuten', modifier: 'QS x 3 Minuten', unit: null },
            unit: null,
        },
        talent: null,
        spell: {
    ...
    },
    {
        ...
        effect: {
            description: '',
            duration: { amount: '1 Minute', modifier: '1 Minute', unit: null },
            unit: null,
        },
        talent: null,
        spell: {
    ...
    },
    {
        ...
        effect: {
            description: '',
            duration: { amount: 'QS x 2 Minuten', modifier: 'QS x 2 Minuten', unit: null },
            unit: null,
        },
        talent: null,
        spell: {
    ...
    },
    {
        ...
        effect: {
            description: '',
            duration: { amount: 'QS x 3 Stunden', modifier: 'QS x 3 Stunden', unit: null },
            unit: null,
        },
        talent: null,
        spell: {
    ...
    },
    {
        ...
        attributes: ['MU', 'IN', 'CH'],
        modified_by: [],
        cost: { initial: 3, additional: { amount: null, interval: null, unit: null }, type: 'asp' },
        effect: {
            description:
    ...
    },
    {
        ...
        effect: {
            ...
            duration: {
                amount: '1 AsP pro 5 Minuten',
                modifier: '1 AsP pro 5 Minuten',
                unit: null,
            },
            unit: null,
        },
    ...
    },
    {
        ...
        attributes: ['IN', 'CH', 'CH'],
        modified_by: [],
        cost: { initial: 6, additional: { amount: null, interval: null, unit: null }, type: 'asp' },
        effect: {
            description:
    ...
    },
    {
        ...
        talent: null,
        spell: {
            duration: { amount: 8, unit: 'Stunden' },
            type: 'Ritual',
            property: 'Sphaeren',
        },
    },
    {
        ...
        talent: null,
        spell: {
            duration: { amount: 30, unit: 'Minuten' },
            type: 'Ritual',
            property: 'Sphaeren',
        },
    },
